...
const router = Router();
async function pushLineMessage(lineUserId, text, imageUrl) {
...
router.post("/create", async (req, res) => {
    try {
        const { condoId, roomId, trackingNo, carrier, senderName, note, imageBase64 } = req.body;
        if (!condoId)
